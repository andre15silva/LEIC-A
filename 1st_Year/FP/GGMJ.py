...
def guru_mj(letras):
    ...
    while n_palavras_por_descobrir > 0:
        ...
        print("JOGADA " + str(n_jogada) + " - Falta descobrir " +
              str(n_palavras_por_descobrir) + " palavras")
        jogada = cria_palavra_potencial(
            input("JOGADOR " + jogador_nome(jogador_atual) + " -> "), letras)
