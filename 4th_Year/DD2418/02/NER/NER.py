...
class NER(object):
    ...
    def determiner_token(self):
        return self.current_token.lower() in ['a', 'an', 'the', 'this', 'that', 'these', 'those', \
                                                'my', 'your', 'his', 'her', 'their', \
                                                'few', 'some', 'many']

    def numeric_token(self):
        return self.current_token != None and self.current_token.isnumeric()
    ...
    def __init__(self, training_file, test_file, model_file, stochastic_gradient_descent,
        ...
        self.features = [
            ...
            NER.FeatureFunction(self.determiner_token),
            NER.FeatureFunction(self.numeric_token)
        ]
