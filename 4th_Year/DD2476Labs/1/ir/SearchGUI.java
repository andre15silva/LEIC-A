...
public class SearchGUI extends JFrame {
    ...
    JRadioButtonMenuItem hitsRankingItem = new JRadioButtonMenuItem("HITS");
    ...
    void init() {
        ...
        rankingMenu.add(hitsRankingItem);
        ...
        hitsRankingItem.addActionListener(setHITSRanking);
