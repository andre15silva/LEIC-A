...
class RestrictedBoltzmannMachine():
    ...
    def get_v_given_h(self,hidden_minibatch):
        ...
        if self.is_top:
            ...
            probabilities_data = sigmoid(support[:, :-self.n_labels])
            probabilities_labels = softmax(support[:, -self.n_labels:])

            activations_data = sample_binary(probabilities_data)
    ...
    def get_v_given_h_dir(self,hidden_minibatch):
        ...
        if self.is_top:
            ...
            raise Exception("No directed connections in the top RBM")
